import re
sample="From Jan 2018 till Nov 2018 I was learning python daily at 10:00 AM"
...
regex=re.compile('(?P<monthe>\w{3})\s+(?P<year>[0-9]{4})')
for m in regex.finditer(sample):
    value=m.groupdict()
    print ("Month: "+value['monthe']+" , "+"Year: "+value['year'])
